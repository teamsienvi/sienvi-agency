  ...
  return (
    <section id="about" className="section-padding bg-transparent relative z-10">
      <div className="container-custom">
          ...
          >
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <motion.div
                  key={i}
                  className="bg-slate-900/65 backdrop-blur-md rounded-xl p-6 text-center border border-slate-800/80 text-white"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
        ...
        {/* Growth systems */}
        <motion.div
          className="bg-slate-900/65 backdrop-blur-md rounded-2xl p-8 md:p-12 mb-20 border border-slate-800/80 text-white"
        ...
        >
          ...
          <p className="font-semibold text-white mb-4">That might look like:</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            {growthItems.map((item, i) => {
              ...
              return (
                <motion.div
                  key={i}
                  className="flex items-start gap-3 bg-slate-900/50 rounded-lg p-4 border border-slate-800/80"
