...
const Index = () => {
  return (
    <motion.div 
      className="min-h-screen bg-transparent relative overflow-x-hidden text-slate-100"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
