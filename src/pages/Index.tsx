...
const testimonials = [
  {
    quote: "Working with Sienvi has been a total game-changer for my brands: Snarky Humans™, Snarky Pets™, and Blingy Bag™. In less than a month, we went from 'just an idea' to a working prototype of MelBot, our branded AI assistant that captures our snarky voice perfectly.\n\nLance did not just talk strategy - he mapped out clear next steps, kept us focused, and got us moving. Thanks to him, we are now building a centralized dashboard for real-time analytics and streamlining VA workflows for faster, smarter advertising.\n\nWould I do this again? Absolutely. If you are serious about automating and scaling with AI (while keeping your brand's personality intact), Lance and Sienve are the ones you want on your side.",
    author: "Mel Goodson",
    position: "Founder of Snarky Ventures"
  },
  {
    quote: "Sienvi has been a fantastic partner for our social media needs. Lance and Scott are incredibly skilled - they really know what they are doing. They have helped us grow our online presence with creative, effective content and a strong sense of strategy.\n\nOn top of their expertise, they are super friendly and very easy to work with. Communication is always smooth, and they consistently go above and beyond. I highly recommend Sienvi to anyone looking for reliable, top-quality social media management.",
    author: "Michael Teng",
